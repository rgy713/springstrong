package com.chinese.identifier;
...
public class ChineseCharIdentifier {
	static List<int[]> chineseCodePointRange = ChineseCharIdentifier
...
//			System.out.println(startCodePoint + ":" + endCodePoint);
	...
	ChineseCharIdentifier(List<String> exceptions) {
