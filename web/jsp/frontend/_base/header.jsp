...
<header role="banner">
    ...
    <nav class="background-white background-primary-hightlight">
        <div class="line">
            <div class="s-12 l-2">
                <a href="home" class="logo"><img src="<c:url value = "/assets/img/logo-free.png"/>" alt=""></a>
            </div>
            <div class="top-nav s-12 l-10">
                <p class="nav-text"></p>
                <ul class="right chevron">
                    <li><a href="home"><s:message code="home"/></a></li>
                    <li><a href="products"><s:message code="products"/></a></li>
                    <%--<li><a><s:message code="service"/></a>
                        <ul>
                            <li><a><s:message code="service1"/></a>
                                <ul>
                                    <li><a href="primium"><s:message code="service1a"/></a></li>
                                    <li><a><s:message code="service1b"/></a></li>
                                </ul>
                            </li>
                            <li><a href="webgl_sample"><s:message code="service2"/></a></li>
                        </ul>
                    </li>--%>
                    <li><a href="about"><s:message code="about"/></a></li>
                    <%--<li><a href="gallery"><s:message code="gallery"/></a></li>--%>
                    <li><a href="contact"><s:message code="contact"/></a></li>
                </ul>
            </div>
        </div>
    </nav>
